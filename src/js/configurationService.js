angular.module('starter').factory('configurationService', function($http, $q, $rootScope, $state, qmService, qmLogService, $timeout){
    ...
    var menuItems = {
        ...
        studies: {
            "title": "Discoveries",
            "stateName": qm.stateNames.studies,
            "icon": "ion-wand"
        },
        predictorSearch: {
    ...
    var subMenus = {
        ...
        recordMeasurement: [
            ...
            {
                "title": "Record a Meal",
                "stateName": qm.stateNames.measurementAddSearch, "params": {"variableCategoryName": "Foods"},
                "icon": "ion-ios-nutrition-outline"
            },
            {
                "title": "Rate an Emotion",
                "stateName": qm.stateNames.measurementAddSearch, "params": {"variableCategoryName": "Emotions"},
                "icon": "ion-happy-outline"
            },
            {
                "title": "Rate a Symptom",
                "stateName": qm.stateNames.measurementAddSearch, "params": {"variableCategoryName": "Symptoms"},
                "icon": "ion-ios-pulse"
            },
            {
                "title": "Record a Treatment",
                "stateName": qm.stateNames.measurementAddSearch, "params": {"variableCategoryName": "Treatments"},
                "icon": "ion-ios-medkit-outline"
            },
            {
            ...
            },
            {
                ...
                "stateName": qm.stateNames.measurementAddSearch, "params": {"variableCategoryName": "Vital Signs"},
                "icon": "ion-ios-pulse"
            }
        ],
        overallMood: [
        ...
        history: [
            ...
            {
                "title": "Emotions",
                "stateName": qm.stateNames.historyAllCategory, "params": {"variableCategoryName": "Emotions"},
                "icon": "ion-happy-outline"
            },
            {
                "title": "Foods",
                "stateName": qm.stateNames.historyAllCategory, "params": {"variableCategoryName": "Foods"},
                "icon": "ion-ios-nutrition-outline"
            },
            {
                "title": "Symptoms",
                "stateName": qm.stateNames.historyAllCategory, "params": {"variableCategoryName": "Symptoms"},
                "icon": "ion-sad-outline"
            },
            {
                "title": "Treatments",
                "stateName": qm.stateNames.historyAllCategory, "params": {"variableCategoryName": "Treatments"},
                "icon": "ion-ios-medkit-outline"
            },
            {
                "title": "Physical Activity",
                "stateName": qm.stateNames.historyAllCategory, "params": {"variableCategoryName": "Physical Activity"},
                "icon": "ion-ios-body-outline"
            },
            {
                "title": "Vital Signs",
                "stateName": qm.stateNames.historyAllCategory, "params": {"variableCategoryName": "Vital Signs"},
                "icon": "ion-ios-pulse"
            },
            {
                "title": "Locations",
                "stateName": qm.stateNames.historyAllCategory, "params": {"variableCategoryName": "Location"},
    ...
    var helpCards = {
        ...
        locationTracking: {
            ...
            goToStateButton: {
                ...
                buttonClass: "button button-clear button-positive ion-checkmark",
                goToState: qm.stateNames.settings
            },
            "bodyText": "Would you like to automatically log location to see how time spent at restaurants, the gym, work or doctors offices might be affecting you? "
        },
        weatherTracking: {
            ...
            goToStateButton: {
                ...
                buttonClass: "button button-clear button-positive ion-checkmark",
                goToState: qm.stateNames.import
            }
        },
        importData: {
            id: "importDataPage",
    ...
    $rootScope.openEditAppSettingsModal = function(appSettingType, appSettingObjectToEdit){
        ...
        if($state.current.name.toLowerCase().indexOf('configuration') === -1){
            ...
            qmService.goToState(qm.stateNames.configuration);  // TODO: Maybe because we used to have buttons on actual menu
        }
